...
{	
	...
	cout << "\n\n\t*** High Scores List ***\n\n";
	cout << left << setw(11) << "Name" << right << setw(5) << "Wins" << right << setw(8) << "Losses" << right << setw(14) << "WinPercent\n\n";
	
	for (int index = 0; index < savesize; index++)
	{
	
	Game.HighScores(index, tempname, tempwins, templosses, temppercent);
	
	cout << left << setw(11) << tempname << right << setw(5) << tempwins << right << setw(8) << templosses << right << setw(11) << temppercent << "%\n";
	}
