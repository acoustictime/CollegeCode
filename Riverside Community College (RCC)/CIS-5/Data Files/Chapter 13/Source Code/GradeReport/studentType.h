...
public:
   ...
   void print(ostream& outF, double tuitionRate);
      ...
      //	If the actual parameter corresponding to outF is 
      //	the object cout, then the output is shown on the 
      //	standard output device.
      //If the actual parameter corresponding to outF is an 
      //	ofstream object, say outFile, then the output goes to
      //	the file specified by outFIle.
