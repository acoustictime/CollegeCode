...
int main()
{
    ...
    if (rectangle1 == rectangle2)                    //Line 19
        cout << "Line 20: rectangle1 and rectangle2 "
             << "are equal." << endl;                //Line 20
    else                                              //Line 21
        cout << "Line 22: rectangle1 and rectangle2 " 
             << "are not equal." << endl;            //Line 22

    if (rectangle1 != rectangle3)                     //Line 23
        cout << "Line 24: rectangle1 and rectangle3 "
             << "are not equal." << endl;             //Line 24
    else                                              //Line 25
        cout << "Line 25: rectangle1 and rectangle3 "
             << "are equal." << endl;                 //Line 26
