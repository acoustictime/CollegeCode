...
public:
    ...
    int getLength() const;
      ...
      //Postcondition: The value of the data member length
      //               is returned.
    int getMaxSize() const;
      //Function to return the maximum number of elements that can
      //be stored in the list.
      //Postcondition: The value of the data member maxSize
      //               is returned.
    void sort();  
    ...
    void insertAt(const elemType& item, int position);
      //Function to insert elemType in the list at the location
